...
test('isNumValidator should return false for negative numbers', async () => {
    expect(isNumValidator('-8')).toBe(false)
})

test('isNumValidator should return false for decimal numbers', async () => {
    expect(isNumValidator('8.1')).toBe(false)
})

test('isNumValidator should return false for inputs of other types', async () => {
...
test('formFieldsValidator should take in an object of type string with attr minimum, maximum, and target. If any value is empty string should return false', async () => {
